...
/*
Read many objects from database based on Employee.lastName
*/
@RunWith(Parameterized.class)
public class DbReadManyTest2 extends BaseDbTest{
    ...
    public DbReadManyTest2(String fname, String lname, int salary, Set set) {
        certificates = set;
